...
#             print(f"Sending request to Groq API: {user_message}")
...
#             # Emit AI response back to all clients
#             await sio_server.emit('chat', {
#                 'sid': 'AI', 
#                 'message': ai_response, 
#                 'type': 'ai',
#                 'threadId': thread_id
#             })
#             print(f"AI response sent: {ai_response[:100]}...")  # Debug log (first 100 chars)
            
#         except Exception as e:
#             print(f"Error in chat handler: {str(e)}")  # Debug log
#             await sio_server.emit('chat', {
#                 'sid': 'System', 
...
#             # Get response from Groq API
#             print(f"Sending request to Groq API with {len(api_messages)} messages")
#             chat_completion = groq_client.chat.completions.create(
